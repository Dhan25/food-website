      ...
      <div className="flex flex-col items-center">
        ...
        <div className="grid lg:grid-cols-3 md:grid-cols-2 gap-8 mb-16">
          {recipes.map((recipe) => {
            return (
              <div
                className=" p-4 shadow-lg hover:shadow transition-all duration-300 cursor-pointer rounded-lg"
                key={recipe.id}
              >
                <img
                  src={recipe.image}
                  alt=""
                  className="rounded-lg mb-4 h-[250px] w-full object-cover object-center"
                />
